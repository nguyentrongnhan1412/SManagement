...
/**
 * Exception thrown when a student ID does not exist.
 * Follows Moodle's exception handling patterns.
 */
class student_not_found_exception extends moodle_exception {
    /**
     * student_not_found_exception constructor.
     * @param int|string $student_id The student ID that was not found
     * @param string|null $debug Additional debug info (optional)
     */
    public function __construct($student_id, $debug = null) {
        $message = 'The requested student (ID: ' . htmlspecialchars($student_id) . ') was not found.';
